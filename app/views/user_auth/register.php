...
<body class="relative min-h-screen font-sans bg-gradient-to-br from-fuchsia-900/80 via-blue-800/70 to-cyan-400/60 flex items-center justify-center overflow-hidden">
  ...
  <div class="glass relative z-10 border-white/60 shadow-2xl p-10 w-full max-w-md animate-fadeIn">
    ...
    <div class="mb-6 flex flex-col items-center">
      ...
      <h1 class="text-3xl font-extrabold text-fuchsia-800 tracking-tight drop-shadow">Register</h1>
    </div>
    ...
    <form method="post" action="<?= site_url('register') ?>" class="space-y-4">
      <div>
        <label for="username" class="block text-fuchsia-800 font-semibold mb-2">Username</label>
      ...
      <div>
        <label for="email" class="block text-fuchsia-800 font-semibold mb-2">Email</label>
      ...
      <div>
        <label for="role" class="block text-fuchsia-800 font-semibold mb-2">Role</label>
    ...
    <p class="text-center mt-4 text-gray-700">Already have an account?
      <a href="<?= site_url('login') ?>" class="text-fuchsia-700 hover:text-cyan-600 font-semibold underline underline-offset-2">Login here</a>
    </p>
  </div>
