    ...
    <div class="w-full max-w-lg relative">
      ...
      <div class="mx-auto relative bg-white/6 border border-white/8 backdrop-blur-md p-10 rounded-3xl shadow-2xl">
        <div class="flex flex-col items-center mb-8">
          ...
          <h1 class="text-3xl font-extrabold text-white tracking-tight mb-1">Create User</h1>
          <p class="text-sm text-white/70">Add a new user to the system</p>
        </div>
        ...
        <p class="mt-5 text-center text-xs text-white/50">By creating a user you agree to the site's terms.</p>
